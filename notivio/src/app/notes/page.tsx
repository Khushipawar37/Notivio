...
interface Note {
  ...
  content: string
  summary?: string
  flashcards: Array<{ id: string; question: string; answer: string; created: Date }>
  created: Date
  modified: Date
}
      ...
      <div className="container mx-auto max-w-7xl p-6">
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-foreground">Notivio Smart Editor</h1>
                <p className="text-muted-foreground">Complete note-taking solution with AI assistance</p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1">
            <AIAssistantPanel content={content} selectedText={selectedText} onContentUpdate={handleContentChange} />
          </div>
        </div>
      </div>
    </div>
