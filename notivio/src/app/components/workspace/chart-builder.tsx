      ...
      <svg width="400" height="250" viewBox="0 0 400 250">
        ${data
          .map((item, index) => {
            ...
            <text x="${
              x + barWidth / 2
            }" y="220" textAnchor="middle" fontSize="12" fill="#666">${
              item.name
            }</text>
      ...
      <svg width="400" height="250" viewBox="0 0 400 250">
        ...
        ${data
          .map((item, index) => {
            ...
            <text x="${x}" y="220" textAnchor="middle" fontSize="12" fill="#666">${
              item.name
            }</text>
            <text x="${x}" y="${
              y - 10
      ...
      <svg width="400" height="250" viewBox="0 0 400 250">
        ${data
          .map((item, index) => {
            ...
            const startY =
              125 + 80 * Math.sin(((startAngle - 90) * Math.PI) / 180);
            ...
            <text x="${
              200 +
              100 * Math.cos(((startAngle + angle / 2 - 90) * Math.PI) / 180)
            }" 
                  y="${
                    125 +
                    100 *
