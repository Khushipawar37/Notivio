...
export default function CreateNoteDialog({ open, onOpenChange, darkMode }: CreateNoteDialogProps) {
  const { addNote, folders, tags } = useNotes()
  ...
  const [selectedType, setSelectedType] = useState<"document" | "video" | "audio">("document")
