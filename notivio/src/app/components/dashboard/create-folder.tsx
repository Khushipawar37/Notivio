...
export default function CreateFolderDialog({ darkMode }: CreateFolderDialogProps) {
  ...
  const colorOptions = ["#c6ac8f", "#8a7559", "#e74c3c", "#3498db", "#2ecc71", "#f39c12", "#9b59b6", "#1abc9c"]
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button
          variant="outline"
          size="sm"
          className={`${darkMode ? "border-gray-600 hover:bg-gray-700" : "border-[#c6ac8f]/30 hover:bg-[#c6ac8f]/10"}`}
        >
