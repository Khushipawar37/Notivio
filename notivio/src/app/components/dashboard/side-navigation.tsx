...
export default function SideNavigation({
  ...
  return (
    <motion.div
      ...
      className={`w-full lg:w-64 h-fit lg:sticky lg:top-24 ${
        darkMode
            ...
            <div className="mt-1 ml-9 space-y-1">
              ...
              >
                <DialogTrigger asChild>
                  <button
                    className={`w-full flex items-center gap-1 px-3 py-1.5 rounded-lg text-sm ${
                      darkMode
                ...
                <div
                  className={`fixed inset-0 z-50 flex items-center justify-center p-4 ${
                    isCreateFolderOpen ? "block" : "hidden"
                  }`}
                >
                  <div
