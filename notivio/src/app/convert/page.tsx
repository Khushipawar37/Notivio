  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!transcriptResponse.ok) {
        ...
        throw new Error(
          "Failed to fetch video transcript. Please check if the video has captions enabled."
        );
      }
      ...
      <div className="container mx-auto max-w-6xl mb-[12rem]">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold text-black mb-6">
            <span className="bg-gradient-to-r from-[#8a7559] to-[#a68b5b] bg-clip-text text-transparent">
              Notivio
            </span>{" "}
            Video Notes
          </h1>
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
            Transform any YouTube video into comprehensive, structured notes
            with our AI-powered tool. Perfect for students, researchers, and
            lifelong learners.
          </p>
        </motion.div>
        ...
        >
          <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-lg font-semibold text-[#8a7559] mb-2">
                Lightning Fast
              </h3>
              <p className="text-gray-600 text-sm">
                Generate comprehensive notes in seconds using advanced AI
                processing
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-600 text-sm">
                Organized sections, key points, and summaries perfect for
                learning
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-600 text-sm">
                Customize, edit, and organize your notes to fit your specific
                needs
              </p>
            </CardContent>
          </Card>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <CardDescription className="text-base">
                    Paste any YouTube video URL to automatically generate
                    structured notes
                  </CardDescription>
                </div>
              </div>
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-[#8a7559]">
                    ...
                    <Badge
                      variant="secondary"
                      className="bg-[#8a7559]/10 text-[#8a7559]"
                    >
          ...
          >
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 gap-6">
              <div className="flex-1">
                ...
                <h3 className="text-xl text-[#8a7559] font-semibold mb-2">
                  {notes.title}
                </h3>
              ...
              <TabsContent value="raw">
                <Card className="border-0 shadow-xl bg-white/90 backdrop-blur-sm">
                  <CardHeader className="bg-gradient-to-r from-[#f5f0e8] to-white border-b border-[#c6ac8f]/20">
                    ...
                    <CardDescription>
                      Original transcript extracted from the video
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="pt-6">
